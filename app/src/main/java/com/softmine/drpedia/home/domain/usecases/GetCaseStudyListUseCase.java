...
public class GetCaseStudyListUseCase extends UseCase<List<CaseItem>> {

    private final ICaseStudyRepository getCaseRepo;

    @Inject
    GetCaseStudyListUseCase(ICaseStudyRepository getCaseRepo)
    {
